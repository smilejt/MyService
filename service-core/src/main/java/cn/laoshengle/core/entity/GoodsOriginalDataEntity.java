 ...
 * @description:
 * @author: 龙逸
 * @createDate: 2020/05/05 15:18:47
 **/
@Data
@ToString
public class GoodsOriginalDataEntity implements Serializable {
    private static final long serialVersionUID = 3728370119253738856L;
